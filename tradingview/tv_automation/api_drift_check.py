...
_PROBES: list[dict[str, str]] = [
    ...
    {"name": "replay.isReplayStarted",
     ...
     "kind": "function"},
    {"name": "replay.isReplayAvailable",
     "expr": "window.TradingViewApi._replayApi.isReplayAvailable",
     "kind": "function"},
    ...
    {"name": "replay.selectDate",
     ...
     "kind": "function"},
    {"name": "replay.doStep",
     "expr": "window.TradingViewApi._replayApi.doStep",
     "kind": "function"},
    {"name": "replay.toggleAutoplay",
     "expr": "window.TradingViewApi._replayApi.toggleAutoplay",
     "kind": "function"},
    {"name": "replay.changeAutoplayDelay",
     "expr": "window.TradingViewApi._replayApi.changeAutoplayDelay",
     "kind": "function"},
    {"name": "replay.isAutoplayStarted",
     "expr": "window.TradingViewApi._replayApi.isAutoplayStarted",
     "kind": "function"},
